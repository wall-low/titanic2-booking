        ...
        <form action="{{ route('admin.tickets.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <select name="type" id="type"
                    ...
                    <option value="Первый класс" {{ old('type') == 'Первый класс' ? 'selected' : '' }}>Первый класс</option>
                    <option value="Второй класс" {{ old('type') == 'Второй класс' ? 'selected' : '' }}>Второй класс</option>
                    <option value="Третий класс" {{ old('type') == 'Третий класс' ? 'selected' : '' }}>Третий класс</option>
                    <option value="Люкс" {{ old('type') == 'Люкс' ? 'selected' : '' }}>Люкс</option>
                </select>
                @error('type')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
