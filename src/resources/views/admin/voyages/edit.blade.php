            ...
            <div class="mb-6">
                ...
                <select name="place_departure" id="place_departure"
                    ...
                    @foreach($placeDepartures as $departure)
                        <option value="{{ $departure->id }}" {{ old('place_departure', $voyage->place_departure) == $departure->id ? 'selected' : '' }}>
                            {{ $departure->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mb-6">
                ...
                <select name="iceberg_arrival" id="iceberg_arrival"
                    ...
                    @foreach($icebergArrivals as $arrival)
                        <option value="{{ $arrival->id }}" {{ old('iceberg_arrival', $voyage->iceberg_arrival) == $arrival->id ? 'selected' : '' }}>
                            {{ $arrival->name }}
                        </option>
                    @endforeach
                </select>
