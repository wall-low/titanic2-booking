        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Место отправления</th>
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Место прибытия</th>
                ...
                @forelse($voyages as $voyage)
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('admin.voyages.edit', $voyage) }}" class="text-blue-600 hover:text-blue-900 mr-3">Редактировать</a>
                            <form action="{{ route('admin.voyages.destroy', $voyage) }}" method="POST" class="inline"
                                  onsubmit="return confirm('Вы уверены, что хотите удалить это путешествие?')">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                            Нет путешествий. <a href="{{ route('admin.voyages.create') }}" class="text-blue-600">Добавить первое?</a>
                        </td>
                    </tr>
                @endforelse
            </tbody>
