                ...
                @forelse($orders as $order)
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-3">
                            <a href="{{ route('admin.orders.show', $order) }}" class="text-indigo-600 hover:text-indigo-900">Просмотр</a>
                            <a href="{{ route('admin.orders.edit', $order) }}" class="text-blue-600 hover:text-blue-900">Редактировать</a>
