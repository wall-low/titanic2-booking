                            ...
                            <form action="{{ route('admin.entertainments.destroy', $entertainment) }}"
                                ...
                                <button type="submit"
                                        class="text-gray-600 hover:text-red-600
                                               @if($entertainment->order_items_count > 0) opacity-40 cursor-not-allowed @endif"
                                        {{ $entertainment->order_items_count > 0 ? 'disabled' : '' }}
                                        title="{{ $entertainment->order_items_count > 0 ? 'Используется в ' . $entertainment->order_items_count . ' заказ(е/ах)' : 'Удалить' }}">
