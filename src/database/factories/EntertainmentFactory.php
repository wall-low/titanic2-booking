    ...
    public function definition(): array
    {
        $entertainments = [
            [
                ...
                'image' => 'entertainment-image-rest',
                'category' => 'Питание',
                'price' => 5000,
            ],
            [
            ...
            [
                ...
                'image' => 'entertainment-image-child',
                'category' => 'Детское',
                'price' => 0,
            ],
            [
                ...
                'image' => 'entertainment-image-akro',
                'category' => 'Шоу',
                'price' => 3500,
            ],
            [
                ...
                'image' => 'entertainment-image-dance',
                'category' => 'Вечеринка',
                'price' => 4000,
            ],
            [
                ...
                'image' => 'entertainment-image-ioga',
                'category' => 'Спорт',
                'price' => 2000,
            ],
        ];

        return $this->faker->randomElement($entertainments);
    }
}
